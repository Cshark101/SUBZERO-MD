...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || "Pandemonium-MD",  // Bot's display name
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2348101668050",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || "CSHARK",           // Owner's name
    DEV: process.env.DEV || "2348101668050",                     // Developer's contact number
    DEVELOPER_NUMBER: '2348101668050@s.whatsapp.net',            // Developer's WhatsApp ID

    // ===== AUTO-RESPONSE SETTINGS =====
    AUTO_REPLY: process.env.AUTO_REPLY || "false",              // Enable/disable auto-reply
    AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",// Reply to status updates?
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*PANDEMONIUM BOT VIEWED YOUR STATUS 🤖*",  // Status reply message
    ...
    STICKER_NAME: process.env.STICKER_NAME || "PANDEMONIUM-MD",     // Sticker pack name
    ...
    BOT_IMAGE: process.env.BOT_IMAGE || "https://files.catbox.moe/j06tjh.jpg",  // Bot's "alive" image
    ...
    FOOTER: process.env.FOOTER || "*© Gᴇɴᴇʀᴀᴛᴇᴅ ʙʏ Pandemonium*",  // Bot description
